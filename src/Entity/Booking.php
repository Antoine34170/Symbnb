...
class Booking
{
    ...
    /**
     * Permet de savoir quelles journées sont disponibles à la location
     */
    public function isBookableDates()
    {
        // 1) il faut conaître les daes impossibles pour l'annonce
        $notAvailableDays = $this->ad->getNotAvailableDays();
        // 2)  Il faut comparer les dates choisies avec celle impossibles
        ...
        // Tableau qui contient des chaines de caractères de mes journées non disponibles 
     ...
     * @return array Un tableau d'objet DateTime reprénsenant les jours de la réservations
     */
